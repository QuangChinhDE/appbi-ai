...
const ALL_NAV_ITEMS: NavItem[] = [
  ...
  { labelKey: 'sidebar.nav.govern', href: '/govern', icon: <Landmark className="h-4 w-4" /> },
  { labelKey: 'sidebar.nav.observability', href: '/observability', icon: <Radar className="h-4 w-4" /> },
