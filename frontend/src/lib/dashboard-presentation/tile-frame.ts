...
export const TILE_KPI_LABEL_CLASS = 'dashboard-kpi-label min-w-0 flex-1 line-clamp-2 break-normal hyphens-auto text-[13px] leading-snug font-medium text-text-secondary';
