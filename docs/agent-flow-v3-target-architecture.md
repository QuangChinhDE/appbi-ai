...
| 22 | Một con số chỉ được gán cho thành viên của chiều câu hỏi nêu khi nó ĐÚNG là số của chiều đó: mỗi con số tin cậy được ghi nó là số của thành viên chiều nào / số tổng / tỷ lệ ngay tại `record_evidence`; khi run không có số theo thành viên của chiều được hỏi, số của thành viên chiều khác và phần trăm không từ tỷ lệ nào bị gắn cờ, sửa một vòng, run `partial`; câu trả lời đúng (dòng theo chiều đó, xếp hạng theo chiều đó, từ chối trung thực kèm tổng, tỷ lệ thật) không bị động tới | `tests/test_figures_belong_to_the_breakdown_asked.py::test_a_categorys_figures_given_to_a_state_are_flagged`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_a_row_count_read_as_a_percentage_is_flagged_and_the_total_is_not`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_a_total_of_the_state_chart_is_not_a_states_figure`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_rows_labelled_by_state_deliver_the_breakdown`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_an_honest_refusal_that_states_the_total_is_left_alone`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_a_state_given_the_whole_total_is_corrected_and_marked_partial`, `tests/test_figures_belong_to_the_breakdown_asked.py::test_a_correct_answer_from_state_rows_is_not_touched` |
