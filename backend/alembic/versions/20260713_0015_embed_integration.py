...
opaque embed links (HMAC-signed request) that resolve to a managed,
deduped DashboardPublicLink without exposing that link's own token.

Chained off 20260713_0014 (ai_scope_mode). NOTE: 0014 was untracked WIP at
authoring time; if it lands separately a standard alembic merge may be needed.
