...
class AuditAction(str, enum.Enum):
    ...
    PERSONAL_ACCESS_TOKEN_UPDATED = "personal_access_token_updated"
    PERSONAL_ACCESS_TOKEN_REVOKED = "personal_access_token_revoked"
    PERSONAL_ACCESS_TOKEN_DELETED = "personal_access_token_deleted"
    ...
    WORKBOARD_UNPUBLISHED = "workboard_unpublished"
